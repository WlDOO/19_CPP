...
/*   Updated: 2025/03/29 13:44:31 by najeuneh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm& For)
{
	try
	{
		For.besigned(*this);
	...
	{
		std::cout <<  this->name << " couldn't sign " << For.GetName() << " because " << e.what() << std::endl;
	}
}
...
void	Bureaucrat::executeForm(AForm const & form) const
{
	try {
		...
		std::cout << GetName() << " could not executed " << form.GetName() << " because " << e.what()  << std::endl; 
	}
}